...
for datasetenumerate in range(11,21):
    ...
    train_list_3 = k_folder_list[:int(0.75*0.2*len(k_folder_list))]
    val_list_3 = k_folder_list[int(0.75*len(k_folder_list)):int((0.75+0.2*0.25)*len(k_folder_list))]
    ...
    output = 'recursion' + str(datasetenumerate)
